  ...
  <div class="admin">
  		...
  		<div class="student-page">
	    	...
	    	<div class="student-content">
    			...
    			<table>
    			<tr><td colspan=2 class="t-head" align="center" style="font-weight: 600">修改院长基本信息界面</td></tr>
    			<tr>
    				<td style="font-weight: 600" align="right">院长名称：</td>
    				<td>
    					<input type="text" name="teacher.name" value="${teacher.name }"/>
    				</td>
    			</tr>
    			<tr>
    				<td style="font-weight: 600" align="right">职业描述：</td>
    				<td>
    					<input type="text" name="teacher.manager" value="${teacher.manager }"/>
    				</td>
    			</tr>
    			<tr>
