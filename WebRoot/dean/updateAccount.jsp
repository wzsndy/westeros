  ...
  <div class="admin">
  		...
  		<div class="student-page">
	    	...
	    	<div class="student-content">
	    		<div class="main">
	    		<form action="updateAccount2" method="post">
    			<table>
    				<tr><td colspan=2 class="t-head" align="center" style="font-weight: 600">修改院长账号界面</td></tr>
    				<tr>
    				<td style="font-weight: 600" align="right">账号：</td>
    				<td>
    					<input type="text" name="account.account" value="${account.account}"/>
    				</td>
    				</tr>
    				<tr>
    				<td style="font-weight: 600" align="right">密码：</td>
    				<td>
    					<input type="password" name="account.pwd" value="${account.pwd}"/>
    				</td>
    				</tr>
    				<tr>
    				<td style="font-weight: 600" align="center" colspan="11">
