  ...
  <div class="admin">
  		...
  		<div class="student-page">
	    	...
	    	<div class="student-content">
	    		<div class="main">
	    		<s:form action="updateGrade2" method="post" theme="simple">
    			<table>
    			<tr><td colspan=11 class="t-head" align="center" style="font-weight: 600">修改班级信息</td></tr>
    			<tr>
    				<td style="font-weight: 600" align="right" >班级名称：</td>
    				<td colspan="11">
    					<s:textfield name="grade.name"></s:textfield>
    				</td>
    			</tr>
    			<tr>
    				<td style="font-weight: 600" align="right">班级辅导员：</td>
    				<td colspan="11">
    					<s:select name="grade.teacher.id" value="grade.teacher.id" list="teachers" listKey="Id" listValue="Name" headerKey="1" headerValue="==请选择=="/>
    				</td>
    			</tr>
    			<tr>
