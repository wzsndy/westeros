  ...
  <div class="admin">
  		...
  		<div class="student-page">
	    	...
	    	<div class="student-content">
	    		...
	    		<table>
    			<tr>
    				<td colspan=11 class="t-head" align="center" style="font-weight: 600">
    					院长专业信息
    				</td>
    			</tr>
    			<tr>
    			...
    			<tr align="center">
    				...
    				<td>${major.text }</td>
    				<td>
    					<a href="updateMajor?id=${major.id}&accountNom=${teacher.nom}">修改</a>
    					<a href="deleteMajor?id=${major.id}" onclick="return confirm('确定删除【${major.name}】专业吗？')">删除</a>
    				</td>
    			</tr>
    			</c:forEach>
    		</table>
