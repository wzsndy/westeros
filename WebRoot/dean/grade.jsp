  		...
  		<div class="student-page">
	    	...
	    	<div class="student-content">
	    		...
	    		<table style="width: 1000px">
    				<tr><td colspan=11 class="t-head" align="center" style="font-weight: 600">班级信息</td></tr>
    				<tr>
  						<th>ID</th>
  						<th>班级名称</th>
  						<th>班级所属辅导员</th>
  					...
  					<tr align="center">
  						...
  						<td colspan="11">
  							<a href="updateGrade?gradeId=${grade.id}">修改</a>
  							<a onclick="return confirm('你确定要删除【${grade.name}】信息吗？')" href="deleteGrade?gradeId=${grade.id }">删除</a>
  							<a href="findAllStudent?gradeId=${grade.id}">查看学生</a>
  						</td>
  					</tr>
  					</c:forEach>
    			</table>
